...
def assembleTimeSeries():
    ...
    fileNames = ["/media/bernd/bernd/spe11/csiro/spe11b_time_series.csv",
                 "/media/bernd/bernd/spe11/geos/spe11b_time_series.csv",
                 "/media/bernd/bernd/spe11/ifpen/spe11b_time_series.csv",
                 "/media/bernd/bernd/spe11/kiel/spe11b_time_series.csv",
                 "/media/bernd/bernd/spe11/opengosim/spe11b_time_series.csv",
                 "/media/bernd/bernd/spe11/opm/spe11b_time_series.csv",
                 "/media/bernd/bernd/spe11/pinch/spe11b_time_series.csv",
#                 "/media/bernd/bernd/spe11/pnnl/spe11b_time_series.csv",
                 "/media/bernd/bernd/spe11/tetratech-rps/result1/spe11b_time_series.csv",
                 "/media/bernd/bernd/spe11/tetratech-rps/result2/spe11b_time_series.csv",
                 "/media/bernd/bernd/spe11/ut-csee-pge/result1/spe11b_time_series.csv",
                 "/media/bernd/bernd/spe11/ut-gccc/spe11b_time_series.csv"]
    groups = ["CSIRO", "GEOS", "IFPEN", "Kiel", "OpenGoSim", "OPM", "Pinch", "Tetratech-RPS-1", "Tetratech-RPS-2", "UT-CSEE-PGE", "UT-GCCC"]
