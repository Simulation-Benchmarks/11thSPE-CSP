...
def assembleTimeSeries():
    ...
    fileNames = ["/mnt/k/spe11/csiro/spe11a_time_series.csv",
                 "/mnt/k/spe11/ifpen/spe11a_time_series.csv",
                 "/mnt/k/spe11/opengosim/spe11a_time_series.csv",
                 "/mnt/k/spe11/opm/spe11a_time_series.csv",
                 "/mnt/k/spe11/pau-inria/spe11a_time_series.csv",
                 "/mnt/k/spe11/ut-gccc/spe11a_time_series.csv"]
    groups = ["CSIRO", "IFPEN", "OpenGoSim", "OPM", "Pau-Inria", "UT-GCCC"]
    ...
    for fileName, group, color in zip(fileNames, groups, colors):
        ...
        axsT.set_title(r'\textrm{\textbf{\Large CO$_2$ in sealing units}}')
    ...
    figT.savefig('time_series_seal.pdf', bbox_inches='tight')
