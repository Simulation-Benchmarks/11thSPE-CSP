...
def compareConvection():
    ...
    figM.tight_layout()
    figM.savefig('spe11b_compare_mobile_boxB.png', bbox_inches='tight', dpi=300)
    ...
    figI.tight_layout()
    figI.savefig('spe11b_compare_immobile_boxB.png', bbox_inches='tight', dpi=300)
    ...
    figD.tight_layout()
    figD.savefig('spe11b_compare_dissolved_boxB.png', bbox_inches='tight', dpi=300)
    ...
    figS.tight_layout()
    figS.savefig('spe11b_compare_seal_boxB.png', bbox_inches='tight', dpi=300)
