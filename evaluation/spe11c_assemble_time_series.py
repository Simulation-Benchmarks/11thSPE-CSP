...
def assembleTimeSeries():
    ...
    for i, group in zip(range(len(groups)), groups):
        ...
        if group in calculatedAB:
            ...
            axsA[0, 0].plot(tSpatialMaps, 1e-9*mobileFromSpatialMapsA[columnName], label=label + '\u2736', color=color, linestyle=ls)
            axsPub[1, 0].plot(tSpatialMaps, 1e-9*mobileFromSpatialMapsA[columnName], label=label + '\u2736', color=color, linestyle=ls)
            axsA[0, 1].plot(tSpatialMaps, 1e-9*immobileFromSpatialMapsA[columnName], label=label + '\u2736', color=color, linestyle=ls)
            axsA[1, 0].plot(tSpatialMaps, 1e-9*dissolvedFromSpatialMapsA[columnName], label=label + '\u2736', color=color, linestyle=ls)
            axsA[1, 1].plot(tSpatialMaps, 1e-9*sealFromSpatialMapsA[columnName], label=label + '\u2736', color=color, linestyle=ls)
        else:
            if np.isnan(csvData[:, 3]).all():
                ...
                axsA[0, 0].plot(t, 1e-9*csvData[:, 3], label=label, color=color, linestyle=ls)
                axsPub[1, 0].plot(t, 1e-9*csvData[:, 3], label=label, color=color, linestyle=ls)
            if np.isnan(csvData[:, 4]).all():
                ...
                axsA[0, 1].plot(t, 1e-9*csvData[:, 4], label=label, color=color, linestyle=ls)
            if np.isnan(csvData[:, 5]).all():
                ...
                axsA[1, 0].plot(t, 1e-9*csvData[:, 5], label=label, color=color, linestyle=ls)
            if np.isnan(csvData[:, 6]).all():
                ...
                axsA[1, 1].plot(t, 1e-9*csvData[:, 6], label=label, color=color, linestyle=ls)
        ...
        if group in calculatedAB:
            columnName = group.lower().replace('-', '')
            axsB[0, 0].plot(tSpatialMaps, 1e-9*mobileFromSpatialMapsB[columnName], label=label + '\u2736', color=color, linestyle=ls)
            axsPub[1, 1].plot(tSpatialMaps, 1e-9*mobileFromSpatialMapsB[columnName], label=label + '\u2736', color=color, linestyle=ls)
            axsB[0, 1].plot(tSpatialMaps, 1e-9*immobileFromSpatialMapsB[columnName], label=label + '\u2736', color=color, linestyle=ls)
            axsB[1, 0].plot(tSpatialMaps, 1e-9*dissolvedFromSpatialMapsB[columnName], label=label + '\u2736', color=color, linestyle=ls)
            axsB[1, 1].plot(tSpatialMaps, 1e-9*sealFromSpatialMapsB[columnName], label=label + '\u2736', color=color, linestyle=ls)
        else:
            if np.isnan(csvData[:, 7]).all():
                ...
                axsB[0, 0].plot(t, 1e-9*csvData[:, 7], label=label, color=color, linestyle=ls)
                axsPub[1, 1].plot(t, 1e-9*csvData[:, 7], label=label, color=color, linestyle=ls)
            if np.isnan(csvData[:, 8]).all():
                ...
                axsB[0, 1].plot(t, 1e-9*csvData[:, 8], label=label, color=color, linestyle=ls)
            if np.isnan(csvData[:, 9]).all():
                ...
                axsB[1, 0].plot(t, 1e-9*csvData[:, 9], label=label, color=color, linestyle=ls)
            if np.isnan(csvData[:, 10]).all():
                ...
                axsB[1, 1].plot(t, 1e-9*csvData[:, 10], label=label, color=color, linestyle=ls)

        # scale area to square km
        if group in calculatedC:
            columnName = group.lower().replace('-', '')
            axsC.plot(tSpatialMaps, 1e-6*convectionFromSpatialMaps[columnName], label=label + '\u2736', color=color, linestyle=ls)
            axsPub[0, 1].plot(tSpatialMaps, 1e-6*convectionFromSpatialMaps[columnName], label=label + '\u2736', color=color, linestyle=ls)
        else:
            if np.isnan(csvData[:, 11]).all():
                ...
                axsC.plot(t, 1e-6*csvData[:, 11], label=label, color=color, linestyle=ls)
                axsPub[0, 1].plot(t, 1e-6*csvData[:, 11], label=label, color=color, linestyle=ls)
        ...
        if np.isnan(csvData[:, 12]).all():
            ...
            axsT[0].plot(t, 1e-9*csvData[:, 12], label=label, color=color, linestyle=ls)
            axsPub[2, 0].plot(t, 1e-9*csvData[:, 12], label=label, color=color, linestyle=ls)
        if np.isnan(csvData[:, 13]).all():
            ...
            axsT[1].plot(t, 1e-9*csvData[:, 13], label=label, color=color, linestyle=ls)
            axsPub[2, 1].plot(t, 1e-9*csvData[:, 13], label=label, color=color, linestyle=ls)
    ...
    axsPub[0, 1].set_ylabel(r'$M$ [km$^2$]')
    ...
    axsPub[1, 0].set_ylabel(r'mass [Mt]')
    ...
    axsPub[1, 1].set_ylabel(r'mass [Mt]')
    ...
    axsPub[2, 0].set_title(r'CO2 in sealing units')
    axsPub[2, 0].set_xlabel(r'time [y]')
    axsPub[2, 0].set_ylabel(r'mass [Mt]')
    axsPub[2, 0].set_xscale('log')
    axsPub[2, 0].set_xlim((3e0, 1e3))
    axsPub[2, 0].set_ylim((-0.1, 2))
    axsPub[2, 1].set_title(r'CO2 in boundary volumes')
    axsPub[2, 1].set_xlabel(r'time [y]')
    axsPub[2, 1].set_ylabel(r'mass [Mt]')
