...
dissolvedData = np.genfromtxt('spe11b_dissolved_boxA_from_spatial_maps.csv', delimiter=',', skip_header=1)
sealData = np.genfromtxt('spe11b_seal_boxA_from_spatial_maps.csv', delimiter=',', skip_header=1)
