...
python3 spe11c_visualize_spatial_maps.py -g SINTEF3 OPM4 GEOS2 OpenGoSim2 -f /media/bernd/bernd/spe11/data -t 1000
python3 spe11c_assemble_time_series.py -g CSIRO GEOS1 GEOS2 IFPEN OPM1 OPM2 OPM3 OPM4 TetraTech1 TetraTech2 UT-CSEE -f /media/bernd/bernd/spe11/data -cAB Calgary CTC-CNE OpenGoSim1 OpenGoSim2 -cS Calgary PFLOTRAN -cC Calgary CAU-Kiel CTC-CNE Pau-Inria PFLOTRAN SINTEF1 SINTEF2 SINTEF3 SLB -t /media/bernd/bernd/spe11/evaluation/spe11c/sparse
