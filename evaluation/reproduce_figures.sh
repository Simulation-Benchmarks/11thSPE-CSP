python3 spe11a_visualize_spatial_maps.py -g IFPEN OPM4 Pau-Inria UT-CSEE3 -f /media/bernd/bernd/spe11/data -t 120
...
python3 spe11c_visualize_spatial_maps.py -g SINTEF3 OPM4 GEOS2 TetraTech2 -f /media/bernd/bernd/spe11/data -t 1000
