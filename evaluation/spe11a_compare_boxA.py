...
def compareConvection():
    ...
    if not is_notebook():
        figM.savefig('spe11a_compare_mobA.png', bbox_inches='tight', dpi=300)
        figI.savefig('spe11a_compare_immA.png', bbox_inches='tight', dpi=300)
        figD.savefig('spe11a_compare_dissA.png', bbox_inches='tight', dpi=300)
        figS.savefig('spe11a_compare_sealA.png', bbox_inches='tight', dpi=300)
